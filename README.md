...
---
## Foundation
我非常希望看到这里的同学能够认认真真去系统性的学习整个计算机体系结构。因此我将各个模块中偏向应用的东西都梳理了出来。这些梳理出来的点比较偏工程，稍做迁移就可以应用在我们工作当中。  

我省略了《软件工程》与《数据库系统》的内容，因为我也不太熟悉。我推荐一本《计算机程序的构造和解释（SICP）》，是MIT本科的第一门课，讲述如何构造和分析复杂系统（程序）。我自己也在慢慢看，不论科班还是非科班出身，不断回顾并反思基础的东西，都是非常重要的。
